...
public abstract class StormpathSpringSecurityWebAppConfig extends WebSecurityConfigurerAdapter {
...
//    @Override
//    protected void global(AuthenticationManagerBuilder auth) throws Exception {
//        auth.authenticationProvider(this.stormpathAuthenticationProvider);
//    }
