...
project = u'Stormpath for Spring Security'
...
rst_prolog = """
.. |project| replace:: Stormpath for Spring Security
"""
...
htmlhelp_basename = 'StormpathSpringSecurityStarterDoc'
...
latex_documents = [
  ('index', 'StormpathForSpringSecurity.tex', u'Stormpath for Spring Security Documentation',
...
man_pages = [
    ('index', 'stormpath-for-spring-security', u'Stormpath for Spring Security Documentation',
     [u'Stormpath, Inc.'], 1)
]
...
texinfo_documents = [
  ('index', 'StormpathForSpringSecurity', u'Stormpath for Spring Security Documentation',
   u'Stormpath', 'StormpathForSpringSecurity', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'Stormpath for Spring Security'
