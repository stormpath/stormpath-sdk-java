...
public class LoginServlet extends AbstractHttpServlet {
    ...
    protected void postInit() {
        Assert.hasText(this.loginUrl, "loginUrl property cannot be null or empty.");
        Assert.hasText(this.loginNextUrl, "loginNextUrl property cannot be null or empty.");
    ...
    public void setLoginUrl(String loginUrl) {
        Assert.hasText(loginUrl, "loginUrl argument cannot be null or empty.");
    ...
    public void setLoginNextUrl(String loginNextUrl) {
        Assert.hasText(loginNextUrl, "loginNextUrl argument cannot be null or empty.");
