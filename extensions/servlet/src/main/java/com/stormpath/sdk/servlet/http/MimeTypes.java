...
public abstract class MimeTypes {
    ...
    /**
     * A String equivalent of {@link MimeTypes#APPLICATION_ATOM_XML}.
     */
    ...
    /**
     * A String equivalent of {@link MimeTypes#APPLICATION_FORM_URLENCODED}.
     */
    ...
    /**
     * A String equivalent of {@link MimeTypes#APPLICATION_XHTML_XML}.
     */
    ...
    /**
     * A String equivalent of {@link MimeTypes#MULTIPART_FORM_DATA}.
     */
    ...
    public static MimeType parseMimeType(String mimeType) {
        if (!Strings.hasLength(mimeType)) {
            throw new InvalidMimeTypeException(mimeType, "'mimeType' must not be empty");
        }
        String[] parts = Strings.tokenizeToStringArray(mimeType, ";");
    ...
    public static List<MimeType> parseMimeTypes(String mimeTypes) {
        if (!Strings.hasLength(mimeTypes)) {
