...
public class IdSiteResultController extends AbstractController {
    ...
    private ViewModel onRegistration(final HttpServletRequest request,
    ...
    private ViewModel onAuthentication(HttpServletRequest request,
                                       HttpServletResponse response,
                                       com.stormpath.sdk.idsite.AuthenticationResult result) {

        TransientAuthenticationResult authenticationResult = new TransientAuthenticationResult(result.getAccount());
        saveResult(request, response, authenticationResult);

        return new DefaultViewModel(loginNextUri).setRedirect(true);
    }

    private ViewModel onLogout(HttpServletRequest request,
                               HttpServletResponse response,
                               LogoutResult result) {
    ...
    private void saveResult(HttpServletRequest request, HttpServletResponse response, AuthenticationResult result) {
