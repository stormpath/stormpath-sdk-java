...
public interface FilterChainManager {
    ...
    /**
     * Adds a filter to the 'pool' of available filters that can be used when {@link #addToChain creating filter chains}.
     *
     * @param name   the name to assign to the filter, used to reference the filter in chain definitions
     * @param filter the filter to add to the pool of available filters that can be used
     */
