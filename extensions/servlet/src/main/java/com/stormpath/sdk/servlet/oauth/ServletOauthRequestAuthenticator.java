...
public interface ServletOauthRequestAuthenticator {
     ...
     *
     * @param scopeFactory the {@link com.stormpath.sdk.oauth.ScopeFactory} to be used for this authentication request.
     * @return a new {@link com.stormpath.sdk.oauth.AccessTokenRequestAuthenticator} instance created with the current state of the
     *         this builder.
     */
     ...
     * </p>
     *
     * <p>This method will return a new {@link com.stormpath.sdk.oauth.ResourceRequestAuthenticator} with the current state of the this
     * builder.</p>
     *
     * @param locations the location(s) for the <code>Bearer</code>.
     * @return a new {@link com.stormpath.sdk.oauth.ResourceRequestAuthenticator} instance created with the current state of the
     *         this builder.
     */
     ...
     *     {@link ServletApiRequestAuthenticator#authenticate(javax.servlet.http.HttpServletRequest)} method instead.
     *     </li>
     *     <li>
     ...
     *     should call the {@link ServletApiRequestAuthenticator#authenticate(javax.servlet.http.HttpServletRequest)} method instead.</p>
     *     </li>
     * </ul>
     * <p>Again, if either of these two scenarios above does not apply to your use case, do not call this method; call
     * the {@link ServletApiRequestAuthenticator#authenticate(HttpServletRequest)} method instead.</p>
     *
     * <p>Next, we'll cover these 2 scenarios.</p>
     *
     * <h3>Scenario 1: OAuth (Bearer) Access Token Allowed Locations</h3>
     *
     * <p>By default, this method and {@link ServletApiRequestAuthenticator#authenticate(HttpServletRequest)} will authenticate an OAuth request
     ...
     * {@link ServletApiRequestAuthenticator#authenticate(HttpServletRequest) later requests} and make authorization decisions to allow or deny the API
