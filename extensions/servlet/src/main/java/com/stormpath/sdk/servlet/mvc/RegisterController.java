...
public class RegisterController extends FormController {
    ...
    public static final List<String> ACCOUNT_PROPERTIES = Collections.unmodifiableList(Arrays.asList("email", "username", "password", "givenName", "middleName", "surname", "phones", "factors"));
