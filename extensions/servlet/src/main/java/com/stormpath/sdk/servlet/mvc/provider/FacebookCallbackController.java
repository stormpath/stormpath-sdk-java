...
public class FacebookCallbackController extends AbstractSocialCallbackController {
    ...
    public FacebookCallbackController(String loginNextUri, Saver<AuthenticationResult> authenticationResultSaver, Publisher<RequestEvent> requestEventPublisher) {
