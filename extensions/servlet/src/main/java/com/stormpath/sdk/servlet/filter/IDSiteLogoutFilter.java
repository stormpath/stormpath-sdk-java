 ...
 * @since 1.0.0
 */
    public class IDSiteLogoutFilter extends ControllerFilter {

    @Override
    protected void onInit() throws ServletException {
        //LogoutController c = new LogoutController(getConfig().getLogoutControllerConfig(), getConfig().getProducesMediaTypes());
        IdSiteLogoutController c = new IdSiteLogoutController(getConfig().getLogoutControllerConfig(), getConfig().getProducesMediaTypes());
        ...
        //TODO 542: missing loogut listener here
        c.setServerUriResolver(getConfig().getServerUriResolver());
        c.setIdSiteResultUri(getConfig().getIDSiteResultUri());
