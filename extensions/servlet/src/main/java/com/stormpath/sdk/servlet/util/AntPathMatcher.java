 ...
 *
 * <p>Part of this code has been kindly borrowed from
 * <a href="http://ant.apache.org">Apache Ant</a>, the <a href="http://www.springframework.org">Spring Framework</a>
 * and <a href="http://shiro.apache.org">Apache Shiro</a>.
 *
...
public class AntPathMatcher implements PatternMatcher {
    ...
    protected boolean doMatch(String pattern, String path, boolean fullMatch) {
        ...
        String[] pattDirs = Strings.tokenizeToStringArray(pattern, this.pathSeparator);
        String[] pathDirs = Strings.tokenizeToStringArray(path, this.pathSeparator);
    ...
    public String extractPathWithinPattern(String pattern, String path) {
        String[] patternParts = Strings.tokenizeToStringArray(pattern, this.pathSeparator);
        String[] pathParts = Strings.tokenizeToStringArray(path, this.pathSeparator);
