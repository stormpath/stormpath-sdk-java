...
import com.stormpath.sdk.lang.CompoundComparator;
...
public class MediaType extends MimeType implements Serializable {
     ...
     * @throws com.stormpath.sdk.servlet.http.InvalidMediaTypeException if the string cannot be parsed
     */
    public static MediaType parseMediaType(String mediaType) {
        MimeType type;
        try {
            type = MimeTypes.parseMimeType(mediaType);
        }
    ...
    public static String toString(Collection<MediaType> mediaTypes) {
        return MimeTypes.toString(mediaTypes);
    }
