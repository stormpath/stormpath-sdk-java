...
public final class Groups {
     ...
     * instance reflecting the specified {@link Group} instance.  The builder can be used to customize any
     ...
     *         instance reflecting the specified {@link Group} instance.
     * @see com.stormpath.sdk.application.Application#createGroup(CreateGroupRequest) Application#createGroup(CreateGroupRequest)
     * @since 0.8.2
     */
