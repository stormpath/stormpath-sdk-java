 ...
 * @since 1.0.RC7
 */
public interface OAuthBearerRequestAuthenticationBuilder extends OAuthRequestAuthenticationBuilder<OAuthBearerRequestAuthentication> {
     ...
     */
    OAuthBearerRequestAuthenticationBuilder setJwt(String jwt);
}
