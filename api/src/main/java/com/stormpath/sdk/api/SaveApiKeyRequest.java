...
/**
 * Represents an attempt to save a new {@link com.stormpath.sdk.api.ApiKey} record in Stormpath.
 *
 * @see ApiKey#save(SaveApiKeyRequest)
 * @since 1.1.beta
 */
public interface SaveApiKeyRequest {
     ...
     * references as part of Stormpath's response upon successful api key update.
     * <p/>
     ...
     * Stormpath's response upon successful api key update.
     * <p/>
     * You should always invoke this method to see if it is safe to invoke the
     ...
     * encrypted with a specific key size as part of Stormpath's response upon successful api key update.
     * <p/>
     ...
     * encrypted with a specific key iteration number as part of Stormpath's response upon successful api key update.
     * <p/>
     ...
     * encrypted with a specific key salt as part of Stormpath's response upon successful api key update.
     * <p/>
