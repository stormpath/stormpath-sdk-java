...
/**
 * A Builder to construct {@link SaveApiKeyRequest}s.
 *
 * @see com.stormpath.sdk.api.ApiKey#save(SaveApiKeyRequest)
 * @since 1.1.beta
 */
public interface SaveApiKeyRequestBuilder {

    /**
     * Ensures that after an ApiKey is saved, the response is retrieved with the specified api key's
     ...
     *      upon successful api key update.
     * </b>
     *  <p/>
     *
