...
/**
 * Interface that defines the available HTTP authentication schemes to be used when communicating with the Stormpath API server.
 * </pre>
 ...
 * need to set {@link BasicAuthenticationScheme} in order for your code to properly communicate with Stormpath API server.
 * </pre>
