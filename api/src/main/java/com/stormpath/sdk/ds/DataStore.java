...
public interface DataStore {
    ...
    /**
     * Retrieves the resource at the specified {@code href} according to the specified {@code Options} and returns the resource as an instance of the specified {@code clazz}.
     *
     ...
     * @since 1.0.RC4
     */
    <T extends Resource> T getResourceExpanded(String href, Class<T> clazz, Options options);
