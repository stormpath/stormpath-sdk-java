 ...
 * @since 1.0.beta
 */
class DefaultProviderDataTest {

    @Test
    void testGetPropertyDescriptors() {

        def providerData = new DefaultProviderData(createStrictMock(InternalDataStore))
    ...
    void testMethods() {
        ...
        def providerData = new DefaultProviderData(internalDataStore, properties)
