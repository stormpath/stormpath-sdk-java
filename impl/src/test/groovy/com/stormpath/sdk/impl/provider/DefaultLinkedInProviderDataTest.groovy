 ...
 * @since 1.0.0
 */
class DefaultLinkedInProviderDataTest {

    @Test
    void testGetPropertyDescriptors() {

        def providerData = new DefaultLinkedInProviderData(createStrictMock(InternalDataStore))
        ...
        assertTrue(LinkedInProviderData.isInstance(providerData))
    }
    ...
    void testMethods() {
        ...
        def providerData = new DefaultLinkedInProviderData(internalDataStore, properties)

        assertEquals(providerData.getHref(), "https://api.stormpath.com/v1/accounts/iouertnw48ufsjnsDFSf/providerData")
        assertEquals(providerData.getProviderId(), "linkedin")
    ...
    void testConstructor() {
        ...
        def internalDataStore = createStrictMock(InternalDataStore)
        def providerData = new DefaultLinkedInProviderData(internalDataStore)
