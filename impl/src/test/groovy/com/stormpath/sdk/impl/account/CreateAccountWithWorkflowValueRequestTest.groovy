 ...
 * @since 0.8.2
 */
class CreateAccountWithWorkflowValueRequestTest {

    @Test
    void testAll() {

        def account = createStrictMock(Account)
        def request = new CreateAccountWithWorkflowValueRequest(account, false)
        ...
        request.accept(new CreateAccountRequestVisitor() {
            ...
            void visit(CreateAccountWithWorkflowValueRequest createAccountWithWorkflowValueRequest) {
                assertSame(createAccountWithWorkflowValueRequest, request)
            }
        })
    }
}
