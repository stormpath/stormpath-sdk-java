...
class DefaultFacebookProviderDataTest {
    ...
    void testGetPropertyDescriptors() {
        ...
        def providerData = new DefaultFacebookProviderData(createStrictMock(InternalDataStore))
    ...
    void testMethods() {
        ...
        def providerData = new DefaultFacebookProviderData(internalDataStore, properties)
