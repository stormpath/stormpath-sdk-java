 ...
 * @since 1.0.RC7
 */
class DefaultOAuthRefreshOktaTokenRequestAuthenticationBuilderTest {

    @Test
    void testError(){
        def builder = new DefaultOAuthRefreshTokenRequestAuthenticationBuilder()
    ...
    void testMethods(){
        ...
        OAuthRefreshTokenRequestAuthentication request = builder.build()
