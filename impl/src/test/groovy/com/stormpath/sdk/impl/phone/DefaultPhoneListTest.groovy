...
class DefaultPhoneListTest {
    ...
    void testAll() {
        ...
        DefaultPhoneList resourceWithProps = new DefaultPhoneList(internalDataStore, [href: "https://api.stormpath.com/v1/phones/werw84u2834wejofe/groups"])
        ...
        assertEquals(propertyDescriptors.get("items").getType(), Phone)
