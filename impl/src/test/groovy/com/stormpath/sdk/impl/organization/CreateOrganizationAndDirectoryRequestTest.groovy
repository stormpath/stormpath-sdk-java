 ...
 * @since 1.0.RC7
 */
class CreateOrganizationAndDirectoryRequestTest {

    @Test
    void testAll() {

        def org = createStrictMock(Organization)
        def request = new CreateOrganizationAndDirectoryRequest(org, "directoryName")
        ...
        request.accept(new CreateOrganizationRequestVisitor() {
            ...
            void visit(CreateOrganizationAndDirectoryRequest CreateOrganizationAndDirectoryRequest) {
                assertSame(CreateOrganizationAndDirectoryRequest, request)
            }
        })
