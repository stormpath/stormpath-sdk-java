...
public class DefaultCreateRegisteredSamlServiceProviderRequest implements CreateRegisteredSamlServiceProviderRequest {
    ...
    public DefaultCreateRegisteredSamlServiceProviderRequest(RegisteredSamlServiceProvider registeredSamlServiceProvider, RegisteredSamlServiceProviderOptions options) {
