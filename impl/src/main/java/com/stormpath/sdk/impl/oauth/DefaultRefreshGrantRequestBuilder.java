...
public class DefaultRefreshGrantRequestBuilder implements RefreshGrantRequestBuilder {
    ...
    @Override
    public DefaultRefreshGrantRequestBuilder setRefreshToken(String refreshToken) {
    ...
    public RefreshGrantRequest build() {
        ...
        DefaultRefreshGrantRequest request = new DefaultRefreshGrantRequest(refreshToken);
        return request;
    }
}
