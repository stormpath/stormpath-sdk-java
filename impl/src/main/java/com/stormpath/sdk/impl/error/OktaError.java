...
public class OktaError extends AbstractResource implements Error, Serializable {
    ...
    static final StringProperty ERROR_DESCRIPTION = new StringProperty("error_description");
    ...
    public OktaError setStatus(int status) {
    ...
    public String getMessage() {
        ...
        String errorDescription = getString(ERROR_DESCRIPTION);
        if (Strings.hasText(errorDescription)) {
