 ...
 * @since 1.0.RC8.2
 */
public interface OAuthClientCredentialsAuthenticationAttempt extends Resource {

    /**
     * Method used to set the apiKeyId to be used in the token exchange request.
     * @param id the apiKeyId to be used in the exchange request.
     */
    void setApiKeyId(String id);

    /**
     * Method used to set the apiKeySecret to be used in the token exchange request.
     * @param secret the apiKeyId to be used in the exchange request.
     */
    void setApiKeySecret(String secret);
