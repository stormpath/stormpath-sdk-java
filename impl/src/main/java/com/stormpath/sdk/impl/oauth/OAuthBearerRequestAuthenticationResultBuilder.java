...
/**
 * This builder is used to obtain an {@link com.stormpath.sdk.oauth.OAuthBearerRequestAuthenticationResult JwtAuthenticationResult} object from the result obtained after a JWT Authentication is performed.
 *
 * @since 1.0.RC7
 */
