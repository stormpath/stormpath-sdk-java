...
public class DefaultFactorList extends AbstractCollectionResource<Factor> implements FactorList {
    ...
    public DefaultFactorList(InternalDataStore dataStore) {
        super(dataStore);
    }

    public DefaultFactorList(InternalDataStore dataStore, Map<String, Object> properties) {
        super(dataStore, properties);
    }

    public DefaultFactorList(InternalDataStore dataStore, Map<String, Object> properties, Map<String, Object> queryParams) {
