 ...
 * @since 1.0.RC5
 */
public abstract class AbstractCreateOauthTokenAttempt extends AbstractResource {
    ...
    public AbstractCreateOauthTokenAttempt(InternalDataStore dataStore) {
        super(dataStore);
    }

    public AbstractCreateOauthTokenAttempt(InternalDataStore dataStore, Map<String, Object> properties) {
