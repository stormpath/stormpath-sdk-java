...
public class OktaApplicationAccountStoreMapping extends AbstractInstanceResource implements ApplicationAccountStoreMapping {
    ...
    public OktaApplicationAccountStoreMapping(InternalDataStore dataStore) {
        super(dataStore);
    }

    public OktaApplicationAccountStoreMapping(InternalDataStore dataStore, Map<String, Object> properties) {
