...
This release includes documentation for multi-factor authentication, bug fixes, and a change in the JSON structure of the /me endpoint (now returns `groups.items` instead of `groups`). 
