/*
 * Copyright 2012 Stormpath, Inc. and original authors. All Rights Reserved.
 *
...
import com.stormpath.sdk.util.LinkedCaseInsensitiveMap;
import com.stormpath.sdk.util.MultiValueMap;
...
public class HttpHeaders implements MultiValueMap<String, String> {
    ...
    /**
     * Set the list of acceptable {@linkplain java.nio.charset.Charset charsets}, as specified by the {@code Accept-Charset} header.
     *
